...
介绍一种方法：先把这个矩阵和单位矩阵拼起来，类似这样：$\left[\begin{array}{c c|c c} a&b&1&0 \\ c&d&0&1 \end{array}\right]$（这 $\text{KaTeX}$ 好难打），然后进行初等行变换直到左边为单位矩阵，类似这样：$\left[\begin{array}{c c|c c} 1&0&e&f \\ 0&1&g&h \end{array}\right]$，右边的就是 $A$ 的逆。
